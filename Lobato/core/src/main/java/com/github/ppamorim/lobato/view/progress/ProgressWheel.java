package com.github.ppamorim.lobato.view.progress;
...
public class ProgressWheel extends View {
    ...
    private static final String SIN_ANIMATION = "sinAnimation";
    private static final String COS_ANIMATION = "cosAnimation";
    private static final String SQRT_ANIMATION = "sqrtAnimation";
    ...
    private float baseFastSpinSpeed;
    private String styleAnimation;
    ...
    private float fastSpinSpeed = 2*spinSpeed;
    ...
    private void parseAttributes(TypedArray a) {
        ...
        baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel_spinSpeed, spinSpeed / 360.0f);
        baseFastSpinSpeed = a.getFloat(R.styleable.ProgressWheel_fastSpinSpeed, fastSpinSpeed / spinSpeed);
        styleAnimation = a.getString(R.styleable.ProgressWheel_styleAnimation);

        spinSpeed = baseSpinSpeed * 360;
        fastSpinSpeed = baseFastSpinSpeed * 360;
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        ...
        if (pausedTimeWithoutGrowing >= pauseGrowingTime) {
            ...
            float distance = changeTypeAnimation(timeStartGrowing, barSpinCycleTime);
    ...
    private float changeTypeAnimation(double timeStartGrowing, double barSpinCycleTime) {
        if(styleAnimation != null && styleAnimation.equals(SIN_ANIMATION)) {
            return (float) Math.sin((timeStartGrowing / barSpinCycleTime) * Math.PI) / 4 + 0.5f;
        } else {
            return (float) Math.cos((timeStartGrowing / barSpinCycleTime + 1) * Math.PI) / 2 + 0.5f;
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        Utils.log("mProgress:" + ss.mProgress + " value mProgress: " + this.mProgress);
        return ss;
    }
