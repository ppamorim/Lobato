package com.github.ppamorim.lobato.view.sliders;
...
import com.github.ppamorim.lobato.core.CustomView;
...
public class MaterialSwitch extends CustomView {
    ...
    int backgroundColor = getResources().getColor(R.color.lobato_reset_view);
    Ball ball;
    boolean check = false;
...
// Color by hexadecimal
        ...
        check = attrs.getAttributeBooleanValue(MATERIAL_DESIGN_XML, "check",
                false);
        eventCheck = check;
...
// Crop line to transparent effect
        ...
        paint.setColor((check) ? getResources().getColor(R.color.lobato_disabled_view) : getResources().getColor(R.color.lobato_reset_view));
        paint.setStrokeWidth(Utils.dpToPx(2, getResources()));
        temp.drawLine(getHeight() / 2, getHeight() / 2, getWidth()
                - getHeight() / 2, getHeight() / 2, paint);
        Paint transparentPaint = new Paint();
        transparentPaint.setAntiAlias(true);
        transparentPaint.setColor(getResources().getColor(R.color.lobato_disabled_view));
