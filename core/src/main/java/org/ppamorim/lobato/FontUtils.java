...
public final class FontUtils {
    ...
    static void applyFont(Context context, TextView textView, AttributeSet attrs) {
        TypedArray style = context.obtainStyledAttributes(attrs, R.styleable.lobato_font);
        applyFont(context, textView, style.getString(R.styleable.lobato_font_primary_font));
        style.recycle();
    }
